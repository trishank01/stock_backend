...
// Example: http://localhost:8080/nse/get_indices
...
// Example: http://localhost:8080/nse/get_quotes
...
// Example: http://localhost:8080/nse/get_quote_info?companyName=TCS
...
// Example: http://localhost:8080/nse/get_multiple_quote_info?companyNames=TCS,WIPRO
...
// Example: http://localhost:8080/nse/get_gainers
...
// Example: http://localhost:8080/nse/get_losers
...
// Example: http://localhost:8080/nse/get_incline_decline
...
// Example: http://localhost:8080/nse/get_index_stocks?symbol=nifty
...
// Example: http://localhost:8080/nse/search_stocks?keyword=AXIS
...
// Example: http://localhost:8080/nse/get_intra_day_data?companyName=TCS&time=1
// Example: http://localhost:8080/nse/get_intra_day_data?companyName=TCS&time=month
...
// Example: http://localhost:8080/nse/get_52_week_high
...
// Example: http://localhost:8080/nse/get_52_week_low
...
// Example: http://localhost:8080/nse/get_top_value_stocks
...
// Example: http://localhost:8080/nse/get_top_volume_stocks
...
// Example: http://localhost:8080/nse/get_stock_futures_data?companyName=TCS&time=15
// Example: http://localhost:8080/nse/get_stock_futures_data?companyName=VEDL&time=month
...
// Example: http://localhost:8080/nse/get_chart_data_new?companyName=VEDL&time=5
// Example: http://localhost:8080/nse/get_chart_data_new?companyName=VEDL&time=year
...
// Example: http://localhost:8080/bse/get_indices
...
// Example: http://localhost:8080/bse/getIndexInfo?indexId=16
...
// Example: http://localhost:8080/bse/get_index_chart_data?indexId=16
...
// Example: http://localhost:8080/bse/get_index_stocks?indexId=16
...
// Example: http://localhost:8080/bse/get_company_info?companyKey=500325
...
// Example: http://localhost:8080/bse/get_stocks_chart_data?companyKey=500325&time=5
// Example: http://localhost:8080/bse/get_stocks_chart_data?companyKey=500325&time=month
...
// Example: http://localhost:8080/bse/get_stock_info_and_day_chart_data?companyKey=500325
...
// Example: http://localhost:8080/bse/get_gainers
...
// Example: http://localhost:8080/bse/get_losers
...
// Example: http://localhost:8080/bse/getTopTurnOvers
